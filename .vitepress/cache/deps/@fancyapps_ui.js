...
var t6 = (t9 = true, e10 = "--f-scrollbar-compensate", s11 = "--f-body-margin", o10 = "hide-scrollbar") => {
...
var D = () => {
  ...
  function ke() {
    ...
    if (K = {}, null == r7 || r7.remove(), r7 = void 0, C = void 0, A2 = void 0, z.delete($), !z.size && (t6(false), document.documentElement.classList.remove(B), Z("placeFocusBack") && l8 && !l8.closest("[inert]"))) try {
